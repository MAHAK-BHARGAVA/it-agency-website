  ...
  return (
    <section className="relative overflow-hidden bg-white py-20 md:py-24 lg:py-32">
      ...
      <motion.div
        aria-hidden
        animate={
          shouldReduceMotion ? undefined : { y: [0, -16, 0], rotate: [0, 5, 0] }
        }
      ...
      <motion.div
        aria-hidden
        animate={
          shouldReduceMotion ? undefined : { y: [0, 14, 0], rotate: [0, -6, 0] }
        }
        transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
            ...
            <motion.div
              animate={
                shouldReduceMotion
                  ...
                  : {
                      y: [0, -12, 0],
                      backgroundColor: ["#ffffff", "#ecfccb", "#ffffff"],
                    }
              }
